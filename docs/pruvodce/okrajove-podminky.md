...
1. Načtěte stěnu a ověřte její orientaci.
2. Pokud používáte automatiku, spusťte detekci kontextu a prohlédněte náhled.
...
5. Zkontrolujte vrstvy, délky a varování v Preview; u automaticky rozpoznaných detailů věnujte pozornost blokovacím zónám.
6. Po generování ověřte skutečnou výztuž ve [Validačním okně](validace.md).
